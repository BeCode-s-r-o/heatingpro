...
import { useDebounce, usePrevious } from 'src/@app/hooks';
import { themeLayoutConfigs } from '../../../app/layout/layoutConfig';
  ...
  useEffect(() => {
    ...
    if (formChanged) {
      if (settings.layout.style !== newSettings.layout.style) {
        _.set(newSettings, 'layout.config', themeLayoutConfigs.defaults);
      }
              ...
              <PaletteSelector
                ...
                trigger={
                  <div className="flex flex-col items-center space-y-8 w-128 m-8 cursor-pointer group">
                    <SectionPreview className="group-hover:shadow-lg transition-shadow" section="main" />
          ...
          <Controller
            ...
            render={({ field: { value, onChange } }) => (
              <PaletteSelector
                ...
                trigger={
                  <div className="flex flex-col items-center space-y-8 w-128 m-8 cursor-pointer group">
                    <SectionPreview className="group-hover:shadow-lg transition-shadow" section="navbar" />
                    <Typography className="flex-1 text-14 font-semibold mb-24 opacity-80 group-hover:opacity-100">
                      Navbar Palette
                    </Typography>
                  </div>
          ...
          <Controller
            ...
            render={({ field: { value, onChange } }) => (
              <PaletteSelector
                ...
                trigger={
                  <div className="flex flex-col items-center space-y-8 w-128 m-8 cursor-pointer group">
                    <SectionPreview className="group-hover:shadow-lg transition-shadow" section="toolbar" />
                    <Typography className="flex-1 text-14 font-semibold mb-24 opacity-80 group-hover:opacity-100">
                      Toolbar Palette
                    </Typography>
                  </div>
          ...
          <Controller
            ...
            render={({ field: { value, onChange } }) => (
              <PaletteSelector
                ...
                trigger={
                  <div className="flex flex-col items-center space-y-8 w-128 m-8 cursor-pointer group">
                    <SectionPreview className="group-hover:shadow-lg transition-shadow" section="footer" />
                    <Typography className="flex-1 text-14 font-semibold mb-24 opacity-80 group-hover:opacity-100">
                      Footer Palette
                    </Typography>
                  </div>
