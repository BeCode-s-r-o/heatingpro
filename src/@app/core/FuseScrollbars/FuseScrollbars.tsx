...
interface FuseScrollbarsProps {
  scrollToTopOnRouteChange: unknown;
  children?: any;
  className?: string;
  ...
  option?: any;
  ref?: any;
  scrollToTopOnChildChange?: any;
  style?: any;
  id?: any;
}

const FuseScrollbars = forwardRef<any>((props: any, ref: any) => {
  ref = ref || createRef();
...
function mapStateToProps({ store }: any) {
  return {
    customScrollbars: store.settings.current.customScrollbars,
  };
}
