...
`}
      ...
      <ol>
        <li>
          the &quot;value&quot; state with the <code>value</code>/<code>onChange</code> props combination. This state
          represents the value selected by the user, for instance when pressing <kbd className="key">Enter</kbd>.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          <code>handleHomeEndKeys</code> to move focus inside the popup with the <kbd className="key">Home</kbd> and{' '}
          <kbd className="key">End</kbd> keys.
        </li>
        <li>
      ...
      <Typography className="mb-40" component="div">
        You can group the options with the <code>groupBy</code> prop. If you do so, make sure that the options are also
        sorted with the same dimension that they are grouped by, otherwise, you will notice duplicate headers.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          name="Grouped.js"
      ...
      <Typography className="mb-40" component="div">
        For advanced customization use cases, a headless <code>useAutocomplete()</code> hook is exposed. It accepts
        almost the same options as the Autocomplete component minus all the props related to the rendering of JSX. The
        Autocomplete component is built on this hook.
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        Head to the <a href="#customization">customization</a> section for an example with the <code>Autocomplete</code>{' '}
      ...
      <ul>
        <li>
          <a href="#load-on-open">Load on open</a>: it waits for the component to be interacted with to load the
          options.
        </li>
        <li>
      ...
      <Typography className="mb-40" component="div">
        If your logic is fetching new options on each keystroke and using the current value of the textbox to filter on
        the server, you may want to consider throttling requests.
      </Typography>
      <Typography className="mb-40" component="div">
        Additionally, you will need to disable the built-in filtering of the <code>Autocomplete</code> component by
        overriding the <code>filterOptions</code> prop:
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        ...
        <a href="https://developers.google.com/maps/documentation/javascript/overview">Google Maps JavaScript</a> and{' '}
        <a href="https://developers.google.com/maps/documentation/places/web-service/overview">Google Places</a> API.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          name="GoogleMaps.js"
      ...
      <Typography className="mb-40" component="div">
        :::error Before you can start using the Google Maps JavaScript API and Places API, you must sign up and create a
        billing account. :::
      </Typography>
      <Typography className="text-32 mt-40 mb-10 font-700" component="h2">
        Multiple values
      ...
      <Typography className="mb-40" component="div">
        The <code>renderInput</code> prop allows you to customize the rendered input. The first argument of this render
        prop contains props that you need to forward. Pay specific attention to the <code>ref</code> and{' '}
      ...
      <Typography className="mb-40" component="div">
        The component exposes a factory to create a filter method that can be provided to the <code>filterOptions</code>{' '}
...
`}
      ...
      <ul>
        ...
        <li>
          <code>config.limit</code> (<em>number</em> [optional]): Default to null. Limit the number of suggested options
          to be shown. For example, if <code>config.limit</code> is <code>100</code>, only the first <code>100</code>{' '}
          matching options are shown. It can be useful if a lot of options match and virtualization wasn&#39;t set up.
        </li>
        <li>
        ...
        <li>
          <code>config.stringify</code> (<em>func</em> [optional]): Controls how an option is converted into a string so
          that it can be matched against the input text fragment.
        </li>
        <li>
          <code>config.trim</code> (<em>bool</em> [optional]): Defaults to <code>false</code>. Remove trailing spaces.
        </li>
      </ul>
      <Typography className="text-16 mt-16 mb-10" component="h4">
        Returns
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>filterOptions</code> prop of the <code>Autocomplete</code> component, or the parameter of the same name
        for the hook.
      </Typography>
      <Typography className="mb-40" component="div">
...
`}
      ...
      <Typography className="mb-40" component="div">
        By default, the component disables the input <strong>autocomplete</strong> feature (remembering what the user
        has typed for a given field in a previous session) with the <code>{`autoComplete="off"`}</code> attribute.
        Google Chrome does not currently support this attribute setting (
        <a href="https://bugs.chromium.org/p/chromium/issues/detail?id=587466">Issue 587466</a>). A possible workaround
        is to remove the <code>id</code> to have the component generate a random one.
      </Typography>
      <Typography className="mb-40" component="div">
        In addition to remembering past entered values, the browser might also propose <strong>autofill</strong>{' '}
        suggestions (saved login, address, or payment details). In the event you want the avoid autofill, you can try
        the following:
      </Typography>
      <ul>
        <li>
        ...
        <li>
          <Typography className="mb-40" component="div">
            Set <code>{`autoComplete="new-password"`}</code> (some browsers will suggest a strong password for inputs
            with this attribute setting):
          </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        VoiceOver on iOS Safari doesn&#39;t support the <code>aria-owns</code> attribute very well. You can work around
        the issue with the <code>disablePortal</code> prop.
      </Typography>
      <Typography className="text-20 mt-20 mb-10 font-700" component="h3">
        ListboxComponent
      </Typography>
      <Typography className="mb-40" component="div">
        ...
        container has the <code>role</code> attribute set to <code>listbox</code>. This ensures the correct behavior of
