  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        :::info Click-Away Listener is a part of the standalone <a href="/base/getting-started/overview/">MUI Base</a>{' '}
      ...
      <Typography className="mb-40" component="div">
        Please refer to the <a href="/base/react-click-away-listener/">Click-Away Listener</a> component page in the MUI
