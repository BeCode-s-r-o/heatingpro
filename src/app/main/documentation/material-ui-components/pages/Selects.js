  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        ...
        <a href="/material-ui/api/outlined-input/">OutlinedInput</a>, <a href="/material-ui/api/input/">Input</a>, or{' '}
        <a href="/material-ui/api/filled-input/">FilledInput</a>, depending on the variant selected. It shares the same
        styles and many of the same props. Refer to the respective component&#39;s API page for details.
      </Typography>
      ...
      <Typography className="mb-40" component="div">
        :::warning Note that when using FormControl with the outlined variant of the Select, you need to provide a label
        in two places: in the InputLabel component and in the <code>label</code> prop of the Select component (see the
        above demo). :::
      </Typography>
      <Typography className="text-20 mt-20 mb-10 font-700" component="h3">
        Auto width
      ...
      <Typography className="mb-40" component="div">
        ...
        You can find an example with the select mode <a href="/material-ui/react-text-field/#select">in this section</a>
        .
      </Typography>
      <Typography className="text-32 mt-40 mb-10 font-700" component="h2">
        Customization
      ...
      <Typography className="mb-40" component="div">
        ...
        directly as a text field or provide it to the select <code>input</code> prop to have a <code>select</code>{' '}
        field. Notice that the <code>{`"standard"`}</code> variant is easier to customize, since it does not wrap the
        contents in a <code>fieldset</code>/<code>legend</code> markup.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        Like with the single selection, you can pull out the new value by accessing <code>event.target.value</code> in
        the <code>onChange</code> callback. It&#39;s always an array.
      </Typography>
      <Typography className="text-20 mt-20 mb-10 font-700" component="h3">
        Default
      </Typography>
      ...
      <Typography className="mb-40" component="div">
        You can control the open state of the select with the <code>open</code> prop. Alternatively, it is also possible
        to set the initial (uncontrolled) open state of the component with the <code>defaultOpen</code> prop.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        To properly label your <code>Select</code> input you need an extra element with an <code>id</code> that contains
        a label. That <code>id</code> needs to match the <code>labelId</code> of the <code>Select</code> e.g.
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        Alternatively a <code>TextField</code> with an <code>id</code> and <code>label</code> creates the proper markup
        and ids for you:
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        ...
        <code>id</code> attribute of the select element to the <code>InputLabel</code>
