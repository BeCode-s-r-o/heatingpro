...
function ToggleButtonDoc(props) {
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        In this example, text justification toggle buttons present options for left, center, right, and fully justified
        text (disabled), with only one item available for selection at a time.
      </Typography>
      <Typography className="mb-40" component="div">
        <strong>Note</strong>: Exclusive selection does not enforce that a button must be active. For that effect see{' '}
        <a href="#enforce-value-set">enforce value set</a>.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        Multiple selection allows for logically-grouped options, like bold, italic, and underline, to have multiple
        options selected.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
      ...
      <Typography className="mb-40" component="div">
        The buttons can be stacked vertically with the <code>orientation</code> prop set to &quot;vertical&quot;.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
...
`}
      ...
      <ul>
        <li>
          ...
          <code>{`aria-label="label"`}</code>, <code>{`aria-labelledby="id"`}</code> or <code>{`<label>`}</code>.
        </li>
        <li>
          ToggleButton sets <code>{`aria-pressed="<bool>"`}</code> according to the button state. You should label each
          button with <code>aria-label</code>.
        </li>
      </ul>
      <Typography className="text-20 mt-20 mb-10 font-700" component="h3">
        Keyboard
      ...
      <Typography className="mb-40" component="div">
        At present, toggle buttons are in DOM order. Navigate between them with the tab key. The button behavior follows
        standard keyboard semantics.
      </Typography>
    </>
  );
}
