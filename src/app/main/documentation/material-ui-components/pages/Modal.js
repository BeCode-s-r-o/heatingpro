  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        The component renders its <code>children</code> node in front of a backdrop component. The <code>Modal</code>{' '}
      ...
      <Typography className="mb-40" component="div">
        :::info The term &quot;modal&quot; is sometimes used to mean &quot;dialog&quot;, but this is a misnomer. A modal
        window describes parts of a UI. An element is considered modal if{' '}
        <a href="https://en.wikipedia.org/wiki/Modal_window">it blocks interaction with the rest of the application</a>.
        :::
      </Typography>
      <Typography className="mb-40" component="div">
        If you are creating a modal dialog, you probably want to use the <a href="/material-ui/react-dialog/">Dialog</a>{' '}
      ...
      <Typography className="mb-40" component="div">
        Modals can be nested, for example a select within a dialog, but stacking of more than two modals, or any two
        modals with a backdrop is discouraged.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          name="NestedModal.js"
      ...
      <ul>
        ...
        <li>
          ...
          the modal to unmount the child content when closed and fully transitioned.
        </li>
      </ul>
      <Typography className="mb-40" component="div">
      ...
      <Typography className="mb-40" component="div">
        The content of modal is unmounted when closed. If you need to make the content available to search engines or
        render expensive component trees inside your modal while optimizing for interaction responsiveness it might be a
        good idea to change this default behavior by enabling the <code>keepMounted</code> prop:
      </Typography>
...
`}
      ...
      <Typography className="mb-40" component="div">
        As with any performance optimization, this is not a silver bullet. Be sure to identify bottlenecks first, and
        then try out these optimization strategies.
      </Typography>
      <Typography className="text-32 mt-40 mb-10 font-700" component="h2">
        Server-side modal
      </Typography>
