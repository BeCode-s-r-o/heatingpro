  ...
  return (
    <>
      ...
      <Typography className="mb-40" component="div">
        A floating action button appears in front of all screen content, typically as a circular shape with an icon in
        its center. FABs come in two types: regular, and extended.
      </Typography>
      <Typography className="mb-40" component="div">
      ...
      <Typography className="mb-40" component="div">
        <FuseExample
          ...
          className="my-24"
          iframe={false}
          component={require('../components/floating-action-button/FloatingActionButtons.js').default}
      ...
      <Typography className="mb-40" component="div">
        By default, the size is <code>large</code>. Use the <code>size</code> prop for smaller floating action buttons.
      </Typography>
      <Typography className="mb-40" component="div">
        <FuseExample
          ...
          className="my-24"
          iframe={false}
          component={require('../components/floating-action-button/FloatingActionButtonSize.js').default}
        ...
        <FuseExample
          ...
          className="my-24"
          iframe={false}
          component={require('../components/floating-action-button/FloatingActionButtonExtendedSize.js').default}
      ...
      <Typography className="mb-40" component="div">
        ...
        triggered at the same time, we use <code>enterDelay</code> to allow the outgoing Floating Action Button&#39;s
      ...
      <Typography className="mb-40" component="div">
        <FuseExample
          ...
          className="my-24"
          iframe={false}
          component={require('../components/floating-action-button/FloatingActionButtonZoom.js').default}
